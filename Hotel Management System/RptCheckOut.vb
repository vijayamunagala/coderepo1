...
Public Class RptCheckOut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.RptCheckOut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCheckOut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCheckOut = New RptCheckOut()
        rpt.Site = Me.Site
        Return rpt
    End Function
